...
%define		source_name gmpc-stopbutton
Summary:	Stopbutton plugin for Gnome Music Player Client
Summary(pl.UTF-8):	Wtyczka stopbutton dla odtwarzacza Gnome Music Player Client
Name:		gmpc-plugin-stopbutton
Version:	0.15.5.0
Release:	0.1
License:	GPL
...
# Source0-md5:	ef23c2ace387e0f697e3cdbfc3bbdc95
